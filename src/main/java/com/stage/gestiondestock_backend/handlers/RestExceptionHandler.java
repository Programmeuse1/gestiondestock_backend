package com.stage.gestiondestock_backend.handlers;
...
//    public ResponseEntity<ErrorDto> handleException(BadCredentialsException execption, WebRequest webRequest) {
//        final HttpStatus badRequest = HttpStatus.BAD_REQUEST;
//
//        final ErrorDto errorDto = ErrorDto.builder()
//                .code(ErrorCodes.BAD_CREDENTIALS)
//                .httpCode(badRequest.getMessage())
